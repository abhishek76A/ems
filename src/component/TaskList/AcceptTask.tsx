...
const AcceptTask: React.FC<AcceptTaskProps> = ({ data }) => {
    ...
    return (
        <div className="flex-shrink-0 h-full w-[300px] rounded-2xl bg-red-300">
            ...
            <div className="flex justify-between p-5 mt-10">
                <button className="bg-green-500 py-1 px-2 rounded-xl text-sm">
                    Mark as Completed
                </button>
                <button className="bg-red-500 py-1 px-2 rounded-xl text-sm">
                    Mark as Failed
                </button>
            </div>
        </div>
